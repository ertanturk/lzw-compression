...
def calculate_compression_factor(
	...
	try:
		...
		if compressed_size == 0:
			print(
				"Compressed file size is 0, cannot calculate compression factor.",
			)
			return 0.0
...
def calculate_text_compression_metrics(
	...
	try:
		...
		print(
			f"An error occurred while calculating text compression metrics: {e}",
		)
		sys.exit(1)
...
def calculate_image_compression_metrics(
	...
	try:
		...
		print(
			f"An error occurred while calculating image compression metrics: {e}",
		)
		sys.exit(1)
