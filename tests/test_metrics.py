...
@test
def test_entropy_for_two_symbol_uniform_distribution_is_one_bit() -> None:
...
@test
def test_entropy_accepts_multidimensional_arrays() -> None:
...
@test
def test_average_code_length_uses_symbol_count_when_provided() -> None:
...
@test
def test_text_size_metrics_are_self_consistent() -> None:
...
@test
def test_text_compression_metrics_payload_contains_expected_keys() -> None:
...
@test
def test_image_compression_metrics_payload_contains_expected_keys() -> None:
