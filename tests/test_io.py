...
def test_color_bitstream_container_roundtrip():
    ...
    write_color_bitstreams_with_dimensions(red, green, blue, out, height=9, width=13)
    loaded_red, loaded_green, loaded_blue, h, w = open_color_bitstreams_with_dimensions(out)
